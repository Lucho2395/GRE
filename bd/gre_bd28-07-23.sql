...
-- Tiempo de generación: 29-07-2023 a las 03:13:33
...
(60, 'GALON', 'GLL', 0, 1, '2021-10-25 00:00:00'),
...
(67, 'SET', 'NIU', 1, 8, '2022-09-12 12:49:54'),
...
(1, 1, 2, 'superadmin', '$2y$10$oPOOOgTUr4zIh511ATm/q.vzsAmxP.e2.vzyEbRn/1pzyWz2oXj0a', 'cesarjose@bufeotec.com', 'media/usuarios/usuario.jpg', 1, '2020-09-17 00:00:00', '2023-07-27 18:37:00', '2020-09-17 00:00:00'),
...
--
ALTER TABLE `opciones`
  MODIFY `id_opcion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `roles_menus`
  MODIFY `id_rol_menu` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
