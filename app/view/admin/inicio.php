        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4 bg-gradient-success text-white">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Bienvenido a <?= _TITLE_?>, <?php echo $this->encriptar->desencriptar($_SESSION['p_n'],_FULL_KEY_) . ' ' . $this->encriptar->desencriptar($_SESSION['p_p'],_FULL_KEY_);?></h6>
                </div>
